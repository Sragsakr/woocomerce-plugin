...
WooProduct _$WooProductFromJson(Map<String, dynamic> json) => WooProduct(
  ...
  catalogVisibility: $enumDecodeNullable(
    _$WooProductCatalogVisibilityEnumMap,
  ...
  taxStatus: $enumDecodeNullable(
    _$WooProductTaxStatusEnumMap,
    json['tax_status'],
  ),
  ...
  stockStatus: $enumDecodeNullable(
    _$WooProductStockStatusEnumMap,
    json['stock_status'],
  ),
  backorders: $enumDecodeNullable(
    _$WooProductBackorderEnumMap,
    json['backorders'],
  ),
  ...
  attributes: (json['attributes'] as List<dynamic>?)
      ?.map((e) => WooProductItemAttribute.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$WooProductToJson(WooProduct instance) =>
    <String, dynamic>{
      ...
      'day_schedules': instance.daySchedules?.map(
...
FreeProduct _$FreeProductFromJson(Map<String, dynamic> json) =>
    FreeProduct((json['count'] as num).toInt(), (json['id'] as num).toInt());

Map<String, dynamic> _$FreeProductToJson(FreeProduct instance) =>
    <String, dynamic>{'count': instance.count, 'id': instance.id};
...
DaySchedule _$DayScheduleFromJson(Map<String, dynamic> json) =>
    DaySchedule(json['startTime'] as String, json['endTime'] as String);
