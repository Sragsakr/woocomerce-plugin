...
extension WooShippingApi on FlutterWooCommerce {
  ...
  Future<List<ShippingZone>> getShippingZones({bool? useFaker}) async {
    ...
    try {
      ...
      throw Exception(
        "Unexpected error getting shipping zones: ${e.toString()}",
      );
    }
  }
  ...
  Future<ShippingZone> getShippingZone({
    ...
    try {
      ...
      throw Exception(
        "Unexpected error getting shipping zone: ${e.toString()}",
      );
    }
  }
  ...
  Future<List<ShippingMethod>> getShippingMethods({
    ...
    if (isUsingFaker) {
      return [ShippingMethod.fake(), ShippingMethod.fake()];
    }
    ...
    try {
      ...
      throw Exception(
        "Unexpected error getting shipping methods: ${e.toString()}",
      );
    }
  }
  ...
  Future<ShippingMethod> getShippingMethod({
    ...
    try {
      ...
      throw Exception(
        "Unexpected error getting shipping method: ${e.toString()}",
      );
    }
  }
  ...
  Future<ShippingMethod> createShippingMethod({
    ...
    try {
      ...
      throw Exception(
        "Unexpected error creating shipping method: ${e.toString()}",
      );
    }
  }
  ...
  Future<ShippingMethod> updateShippingMethod({
    ...
    try {
      ...
      throw Exception(
        "Unexpected error updating shipping method: ${e.toString()}",
      );
    }
  }
  ...
  Future<bool> deleteShippingMethod({
    ...
    try {
      ...
      throw Exception(
        "Unexpected error deleting shipping method: ${e.toString()}",
      );
    }
  }
}
